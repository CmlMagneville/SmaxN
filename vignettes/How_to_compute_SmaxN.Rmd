...
We can now apply the `SmaxN.computation` function to compute the `SmaxN` metric
among other metrics:
...
(For further explanations, a paper will (hopefully) be available in the next months.
